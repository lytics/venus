...
export function LyticsTopNav() {
  ...
  const getParentSection = () => {
    ...
    // If we're at /lytics/[section]/[something], show the section
    if (pathParts.length > 2) {
      const section = pathParts[1]
      if (section === 'audiences') return { label: 'Audiences', href: '/lytics/audiences' }
      if (section === 'settings') return { label: 'Settings', href: '/lytics/settings' }
    }
