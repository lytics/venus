...
const ExperiencesIcon = () => (
  ...
  >
    <path
      d="M5.342 6.31c.51 4.132.504 8.346-.007 12.477h3.204c.364 0 .658.29.658.648a.653.653 0 01-.658.649H5.177a1.169 1.169 0 01-1.168-1.308c.524-4.13.53-8.347.005-12.476-.092-.726.515-1.353 1.255-1.296l4.05.306c4.447.337 8.915.337 13.363 0l4.049-.306c.74-.057 1.347.57 1.255 1.296-.524 4.13-.52 8.346.005 12.476a1.169 1.169 0 01-1.168 1.308H23.46a.653.653 0 01-.658-.649c0-.358.294-.648.658-.648h3.204a50.986 50.986 0 01-.007-12.477l-3.875.293c-4.516.342-9.05.342-13.566 0L5.342 6.31z"
      fill="currentColor"
      stroke="currentColor"
    />
    <path
...
const AudiencesIcon = () => (
  ...
  >
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M11.854 20.364a4.141 4.141 0 018.273-.29l.017.245a.655.655 0 01-.653.7h-6.982a.655.655 0 01-.655-.655zm1.386-.655h5.513a2.833 2.833 0 00-5.513 0zM16 10.982a2.4 2.4 0 100 4.8 2.4 2.4 0 000-4.8zm-1.09 2.4a1.09 1.09 0 112.18 0 1.09 1.09 0 01-2.18 0z"
      fill="currentColor"
      stroke="currentColor"
    />
    <path
...
const AttributesIcon = () => (
  ...
  >
    <path
      d="M25.991 15.28a.719.719 0 101.434 0c0-1.481-.29-2.948-.855-4.317a11.284 11.284 0 00-2.435-3.66A11.196 11.196 0 0016.191 4a.719.719 0 00-.717.721c0 .398.32.72.717.72a9.767 9.767 0 016.93 2.882 9.875 9.875 0 012.87 6.958zM6.39 15.28a.719.719 0 00-.717-.72.719.719 0 00-.717.72c0 1.481.29 2.948.855 4.317a11.284 11.284 0 002.436 3.66 11.197 11.197 0 007.944 3.304.719.719 0 00.717-.721.719.719 0 00-.717-.72 9.767 9.767 0 01-6.93-2.882 9.874 9.874 0 01-2.87-6.958z"
      fill="currentColor"
      stroke="currentColor"
    />
    <path
...
const EventsIcon = () => (
  ...
  >
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M13.798 13.912c0-1.293 1.05-2.34 2.347-2.34a2.344 2.344 0 012.347 2.34v7.079l1.354-1.21a2.311 2.311 0 013.4.352c.698.949.566 2.27-.307 3.063l-5.088 4.62a.707.707 0 01-.997-.046.703.703 0 01.046-.995l5.089-4.62a.892.892 0 00.119-1.19.897.897 0 00-1.32-.136l-2.531 2.263a.707.707 0 01-1.177-.524v-8.656a.934.934 0 00-.935-.933.934.934 0 00-.935.933v5.217a.705.705 0 01-.706.704h-4.06c-.855 0-1.424.88-1.073 1.656l2.494 5.517a.707.707 0 01-1.287.579l-2.494-5.517c-.773-1.709.48-3.643 2.36-3.643h3.354v-4.513z"
      fill="currentColor"
      stroke="currentColor"
    />
    <path
...
const DashboardIcon = () => (
  ...
  >
    <path
      d="M4 13h6a1 1 0 001-1V4a1 1 0 00-1-1H4a1 1 0 00-1 1v8a1 1 0 001 1zm0 8h6a1 1 0 001-1v-4a1 1 0 00-1-1H4a1 1 0 00-1 1v4a1 1 0 001 1zm10 0h6a1 1 0 001-1v-8a1 1 0 00-1-1h-6a1 1 0 00-1 1v8a1 1 0 001 1zm0-18a1 1 0 00-1 1v4a1 1 0 001 1h6a1 1 0 001-1V4a1 1 0 00-1-1h-6z"
      stroke="currentColor"
      strokeWidth="1.5"
      fill="none"
    />
...
const EntriesIcon = () => (
  ...
  >
    <path
      d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9h6m-6 4h6m-6-8h.01M9 12h.01"
      stroke="currentColor"
      strokeWidth="1.5"
      strokeLinecap="round"
    />
        ...
        <DropdownMenuTrigger asChild>
          <button
            className={cn(
              baseClass,
              !compact &&
                "text-[color:var(--color-heading)] hover:bg-[color:var(--color-surface-gray)]",
            )}
            style={compactStyle}
          >
            <Icon />
            ...
            {compact ? (
              ...
              >
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
                  d="M5.47 11.47a.75.75 0 011.06 0L16 20.94l9.47-9.47a.75.75 0 111.06 1.06l-10 10a.75.75 0 01-1.06 0l-10-10a.75.75 0 010-1.06z"
                  fill="#475161"
                />
              </svg>
            ) : (
  ...
  if (item.disabled) {
    return (
      <button
        className={cn(
          baseClass,
          !compact && "text-[color:var(--color-heading)]",
          "cursor-not-allowed",
        )}
        style={compactStyle}
        disabled
            ...
            <div className="flex items-center gap-2">
              ...
              >
                ...
                >
                  ...
                  <path
                    d="M19.3 14.604V8.677C19.3 4.437 16.027 1 11.994 1 7.962 1 4.691 4.438 4.691 8.677v5.927c0 1.073-.83 1.938-1.845 1.938-1.026 0-1.846.864-1.846 1.937C1 19.323 1.644 20 2.445 20h19.11c.8 0 1.445-.677 1.445-1.52 0-1.074-.83-1.938-1.846-1.938-1.035.01-1.855-.865-1.855-1.938zM11.994 23C10.885 23 10 22.313 10 21.473V20h4v1.473c-.012.85-.909 1.527-2.006 1.527z"
                    stroke="#697B9B"
                    strokeWidth="2"
                    strokeMiterlimit="10"
                  />
              ...
              >
                ...
                >
                  ...
                  <path
                    d="M10.626 14.033c0-1.514.96-2.45 1.823-3.35.665-.707 1.262-1.34 1.262-2.167 0-.973-.502-1.606-1.599-1.606-1.114 0-1.892.844-2.013 2.166H8C8.13 6.57 9.797 5 12.216 5 14.791 5 16 6.496 16 8.35c0 1.36-.777 2.24-1.581 3.085-.847.863-1.71 1.644-1.762 2.718v.615h-2.013v-.735h-.018zm-.483 3.498c0-.844.665-1.496 1.477-1.496.795 0 1.443.652 1.443 1.496 0 .826-.648 1.469-1.443 1.469a1.466 1.466 0 01-1.477-1.469z"
                    fill="#697B9B"
                  />
                </svg>
              </Button>
