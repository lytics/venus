...
const apps: App[] = [
  ...
  { id: "cms", name: "CMS", icon: "/images/icon-headless-cms.svg", href: "/stacks" },
  {
    id: "personalize",
    name: "Personalize",
    icon: "/images/icon-personalize.svg",
    href: "/personalize",
  },
  {
    id: "data-insights",
    name: "Data & Insights",
    icon: "/images/dataandinsights.svg",
    href: "/insights",
  },
        ...
        >
          ...
          >
            ...
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M13 4h6v6h-6V4zm1 1v4h4V5h-4z"
              fill="currentColor"
            />
            ...
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M22 4h6v6h-6V4zm1 1v4h4V5h-4z"
              fill="currentColor"
            />
            ...
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M4 13h6v6H4v-6zm1 1v4h4v-4H5z"
              fill="currentColor"
            />
            ...
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M13 13h6v6h-6v-6zm1 1v4h4v-4h-4z"
              fill="currentColor"
            />
            ...
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M22 13h6v6h-6v-6zm1 1v4h4v-4h-4z"
              fill="currentColor"
            />
            ...
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M4 22h6v6H4v-6zm1 1v4h4v-4H5z"
              fill="currentColor"
            />
            ...
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M13 22h6v6h-6v-6zm1 1v4h4v-4h-4z"
              fill="currentColor"
            />
            ...
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M22 22h6v6h-6v-6zm1 1v4h4v-4h-4z"
              fill="currentColor"
            />
          </svg>
