...
function ShowcaseCard({
  ...
  return (
    <div className={`border border-border rounded-lg p-6 bg-card ${className}`}>
      <div className="text-xs font-semibold text-muted-foreground/50 tracking-normal mb-4">
        {label}
      </div>
      {children}
    </div>
      ...
      <div className="py-8 px-6">
        <main className="space-y-12">
          ...
          <div className="border border-border rounded-lg p-6 bg-card">
            <h2 className="text-sm font-semibold text-muted-foreground/50 tracking-normal mb-4">
              VenusCN Components
            </h2>
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-x-4 gap-y-2 text-sm">
              <div className="space-y-1">
                ...
                <a href="#buttons" className="block text-foreground hover:text-primary">
                  Button
                </a>
                <a href="#inputs" className="block text-foreground hover:text-primary">
                  Input
                </a>
                <a href="#inputs" className="block text-foreground hover:text-primary">
                  Textarea
                </a>
                <a href="#controls" className="block text-foreground hover:text-primary">
                  Checkbox
                </a>
                <a href="#controls" className="block text-foreground hover:text-primary">
                  Radio
                ...
                <a href="#dropdown" className="block text-foreground hover:text-primary">
                  Dropdown
                </a>
              </div>
              <div className="space-y-1">
              ...
              <div className="space-y-1">
                ...
                <a href="#table" className="block text-foreground hover:text-primary">
                  Table
                </a>
                <a href="#table" className="block text-foreground hover:text-primary">
                  TableActionButton
              ...
              <div className="space-y-1">
                ...
                <a href="#tabs" className="block text-foreground hover:text-primary">
                  Tabs
                </a>
                <a href="#pageheader" className="block text-foreground hover:text-primary">
                  PageHeader
                </a>
                <a href="#page-search-header" className="block text-foreground hover:text-primary">
                  PageSearchHeader
                </a>
              </div>
              <div className="space-y-1">
                <div className="font-semibold text-xs text-muted-foreground mb-2">UI Elements</div>
                <a href="#tags" className="block text-foreground hover:text-primary">
                  Tag
                </a>
                <a href="#pills" className="block text-foreground hover:text-primary">
                  Pill
                </a>
                <a href="#status-pills" className="block text-foreground hover:text-primary">
                  StatusPill
                </a>
                <span className="block text-foreground">Divider</span>
                <a href="#tooltips" className="block text-foreground hover:text-primary">
                  Tooltip
                </a>
              </div>
              <div className="space-y-1">
            ...
            <section id="inputs" className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <ShowcaseCard label="Textarea">
                  <Field className="max-w-[800px]">
                    <FieldLabel htmlFor="venus-textarea" optional>
                      Message
                    </FieldLabel>
                ...
                <ShowcaseCard label="Validation States">
                  <div className="space-y-4 max-w-[800px]">
                    <Field>
                      <FieldLabel htmlFor="venus-input-error" required>
                        Error State
                      </FieldLabel>
            ...
            <section id="tags" className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <ShowcaseCard label="Removable Tags">
                  <div className="flex flex-wrap gap-2">
                    <Tag removable onRemove={() => toast.success("Removed")}>
                      React
                    </Tag>
                    <Tag removable onRemove={() => toast.success("Removed")}>
                      TypeScript
                ...
                <ShowcaseCard label="Tag States">
                  <div className="flex flex-wrap gap-2">
                    ...
                    <Tag removable disabled onRemove={() => console.log("disabled")}>
                      Disabled
                    </Tag>
                  </div>
                </ShowcaseCard>
            ...
            <section id="pills" className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <ShowcaseCard label="Removable Pills">
                  <div className="flex flex-wrap gap-2">
                    <Pill removable onRemove={() => toast.success("Removed")}>
                      React
                    </Pill>
                    <Pill removable onRemove={() => toast.success("Removed")} status="success">
                      Approved
                    </Pill>
                    <Pill removable onRemove={() => toast.success("Removed")} variant="chip">
                      Filter
                    </Pill>
                  </div>
                </ShowcaseCard>
                ...
                <ShowcaseCard label="Multiple Actions">
                  <PageHeader
                    ...
                    actions={[
                      {
                        label: "Cancel",
                        onClick: () => toast.success("Cancel"),
                        variant: "ghost",
                        size: "regular",
                      },
                      {
                        label: "Draft",
                        onClick: () => toast.success("Draft"),
                        variant: "secondary",
                        size: "regular",
                      },
                      {
                        label: "Publish",
                        onClick: () => toast.success("Publish"),
                        variant: "primary",
                        size: "regular",
                      },
                    ]}
                  ...
                  <div className="-mx-6 -mb-6">
                    <PageSearchHeader
                      ...
                      actions={[
                        {
                          label: "Import",
                          onClick: () => toast.success("Import"),
                          variant: "secondary",
                        },
                        {
                          label: "Create New",
                          onClick: () => toast.success("Create"),
                          variant: "primary",
                        },
                      ]}
                    />
                    ...
                    <Table full className="min-h-full border-separate border-spacing-0">
                      <TableHeader>
                        <TableRow>
                          ...
                          <TableHead sticky="right" className="w-12 text-center">
                            Actions
                          </TableHead>
                        </TableRow>
                      </TableHeader>
                      <TableBody>
                        <TableRow>
                          ...
                          <TableCell>
                            <StatusPill status="active">Paid</StatusPill>
                          </TableCell>
                          <TableCell>
                            <Tag>Shipped</Tag>
                          </TableCell>
                        ...
                        <TableRow>
                          ...
                          <TableCell>
                            <StatusPill status="paused">Pending</StatusPill>
                          </TableCell>
                          <TableCell>
                            <Tag>Processing</Tag>
                          </TableCell>
