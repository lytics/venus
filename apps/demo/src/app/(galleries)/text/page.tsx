        ...
        <main className="space-y-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground max-w-2xl">
              Typography system with Inter font family and custom text sizes. Base size is 16px.
              Custom sizes: text-13, text-22, text-28, text-34.
            </p>
          </div>
            ...
            <div className="space-y-3 p-4 border rounded-lg">
              ...
              <div className="grid grid-cols-12 gap-4 items-center">
                ...
                <div className="col-span-7 text-sm text-muted-foreground">
                  500 - Venus descriptions, secondary text
                </div>
              </div>
              <div className="grid grid-cols-12 gap-4 items-center">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 p-4 border rounded-lg">
              ...
              <div className="grid grid-cols-12 gap-4 items-center">
                ...
                <div className="col-span-8 text-sm text-muted-foreground">
                  34px • 2.5rem line height • Custom
                </div>
              </div>
              <div className="grid grid-cols-12 gap-4 items-center">
              ...
              <div className="grid grid-cols-12 gap-4 items-center">
                ...
                <div className="col-span-8 text-sm text-muted-foreground">
                  28px • 2.25rem line height • Custom
                </div>
              </div>
              <div className="grid grid-cols-12 gap-4 items-center">
              ...
              <div className="grid grid-cols-12 gap-4 items-center">
                ...
                <div className="col-span-8 text-sm text-muted-foreground">
                  22px • 1.75rem line height • Custom
                </div>
              </div>
              <div className="grid grid-cols-12 gap-4 items-center">
              ...
              <div className="grid grid-cols-12 gap-4 items-center">
                ...
                <div className="col-span-8 text-sm text-muted-foreground">
                  13px • 1.25rem line height • Custom
                </div>
              </div>
              <div className="grid grid-cols-12 gap-4 items-center">
