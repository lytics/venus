...
export default function ColorsPage() {
  ...
  const SimpleColorCard = ({
    ...
    const isSemanticColor = themeColorVars
      .filter((v) => !v.startsWith("--brand-"))
      .includes(colorVar);
    const bgColor = isSemanticColor ? `hsl(var(${colorVar}))` : `var(${colorVar})`;
    ...
    return (
      ...
      >
        <div
          className={`rounded-xl border shadow-sm ${size === "small" ? "w-10 h-10" : "w-16 h-16"} ${
            copiedItem === `${colorName}-simple`
        ...
        <main className="space-y-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground max-w-2xl">
              All colors come from the design token system in{" "}
              <code className="px-2 py-0.5 bg-muted rounded text-xs font-mono text-foreground">
                src/styles/tokens.css
              </code>{" "}
              and are mapped to Tailwind utilities in{" "}
              <code className="px-2 py-0.5 bg-muted rounded text-xs font-mono text-foreground">
                src/app/globals.css
              </code>
              .
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4 text-sm text-muted-foreground">
              ...
              <span className="inline-flex items-center gap-1">
                <span className="text-amber-500">★</span> Primary brand color
              </span>
              <span className="inline-flex items-center gap-1">
                <span className="text-primary">●</span> Used in demo
              </span>
            </div>
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              {!isSimple && (
                <p className="text-xs text-muted-foreground">
                  shadcn/ui compatible semantic tokens. Use directly with Tailwind classes like{" "}
                  <code className="px-2 py-0.5 bg-muted rounded">bg-primary</code>,{" "}
                  <code className="px-2 py-0.5 bg-muted rounded">text-muted-foreground</code>.
                </p>
              )}
                  ...
                  {themeColorVars
                    ...
                    .map((colorVar) => {
                      ...
                      return (
                        <div
                          key={colorName}
                          className={`flex items-center gap-3 p-3 border rounded-lg ${isPrimaryColor ? "border-primary border-2" : ""}`}
                        >
                          <div
                            className={`w-12 h-12 rounded-lg border cursor-pointer transition-all hover:scale-105 hover:shadow-md ${
                              copiedItem === `${colorName}-tile`
            ...
            <div className="space-y-4">
              ...
              {!isSimple && (
                <p className="text-xs text-muted-foreground">
                  Extended purple scale for the primary brand color. Use{" "}
                  <code className="px-2 py-0.5 bg-muted rounded">bg-brand-*</code> or{" "}
                  <code className="px-2 py-0.5 bg-muted rounded">text-brand-*</code>.
                </p>
              )}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {Array.from({ length: 12 }, (_, i) => {
                    ...
                    return (
                      <div
                        key={step}
                        className={`flex items-center gap-3 p-3 border rounded-lg ${isPrimary ? "border-primary border-2" : ""}`}
                      >
                        <div
                          className={`w-12 h-12 rounded-lg border cursor-pointer transition-all hover:scale-105 hover:shadow-md ${
                            copiedItem === `brand-${step}-tile`
                              ? "ring-2 ring-primary animate-pulse"
                              : ""
                          }`}
                  ...
                  <div className="space-y-3 p-4 border rounded-lg">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center gap-3">
                        <div
                          className={`w-12 h-12 rounded-lg border cursor-pointer transition-all hover:scale-105 hover:shadow-md ${
                            copiedItem === "muted-foreground-tile"
                              ? "ring-2 ring-primary animate-pulse"
                              : ""
                          }`}
                        ...
                        <div className="flex-1">
                          <div className="flex items-center gap-3">
                            <code
                              className={`text-sm text-muted-foreground font-medium cursor-pointer transition-all hover:text-primary ${
                                copiedItem === "muted-foreground-code"
                                  ? "text-primary font-bold"
                                  : ""
                              }`}
                              onClick={() =>
                                copyToClipboard("text-muted-foreground", "muted-foreground-code")
                              }
                              title="Click to copy class name"
                            >
                          ...
                          <div className="text-xs text-muted-foreground mt-1">
                            <div>
                              ...
                              <code
                                className={`text-xs cursor-pointer transition-all hover:text-foreground px-2 py-0.5 rounded ${
                                  copiedItem === "muted-foreground-var"
                                    ? "bg-primary text-primary-foreground"
                                    : ""
                                }`}
                                onClick={() =>
                                  copyToClipboard("--muted-foreground", "muted-foreground-var")
                                }
                                title="Click to copy CSS variable"
                              >
                                --muted-foreground
                            ...
                            <div className="mt-1">
                              <code
                                className={`text-xs cursor-pointer transition-all hover:text-foreground px-2 py-0.5 rounded ${
                                  copiedItem === "muted-foreground-hex"
                                    ? "bg-primary text-primary-foreground"
                                    : ""
                                }`}
                          ...
                          <div className="flex items-center gap-3">
                            <code
                              className={`text-sm text-destructive font-medium cursor-pointer transition-all hover:text-destructive/80 ${
                                copiedItem === "destructive-code"
                                  ? "text-destructive/60 font-bold"
                                  : ""
                              }`}
                              onClick={() =>
                                copyToClipboard("text-destructive", "destructive-code")
                              }
                              title="Click to copy class name"
                            >
                              text-destructive
            ...
            <div className="space-y-4">
              ...
              {!isSimple && (
                <p className="text-xs text-muted-foreground">
                  Full color scales for status indicators. Use{" "}
                  <code className="px-2 py-0.5 bg-muted rounded">bg-success-500</code>,{" "}
                  <code className="px-2 py-0.5 bg-muted rounded">text-danger-600</code>, etc.
                </p>
              )}
            ...
            <div className="space-y-4">
              <h3 className="text-base font-semibold text-foreground">
                Chart Colors <span className="font-normal text-muted-foreground">(Not Venus)</span>
              </h3>
              {!isSimple && (
                <p className="text-xs text-muted-foreground">
                  Vibrant colors for charts, graphs, and data visualization. Use{" "}
                  <code className="px-2 py-0.5 bg-muted rounded">bg-chart-rose</code>,{" "}
                  <code className="px-2 py-0.5 bg-muted rounded">bg-chart-blue</code>, etc.
                </p>
              )}
              ...
              {isSimple ? (
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-2">
                  {chartColorVars.map((colorVar) => {
                    const colorName = colorVar.replace("--", "");
                    return (
                      <SimpleColorCard key={colorName} colorVar={colorVar} colorName={colorName} />
                    );
                  })}
                </div>
              ) : (
