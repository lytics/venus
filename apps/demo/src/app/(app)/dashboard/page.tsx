        ...
        <div className="flex flex-col gap-6 px-8 pt-8 pb-8">
          ...
          <div className="mb-3">
            ...
            <p className="text-base font-bold text-[#6e6b86] mt-1">
              Organization Name: Venus Demo Playground
            </p>
          </div>
                ...
                <div className="grid grid-cols-[repeat(auto-fill,208px)] gap-4 mb-8">
                  ...
                  <AppCard>
                    <CardContent className="px-4">
                      ...
                      <p className="text-sm font-medium text-body leading-snug">
                        Create content using best-in-class CMS
                      </p>
                    </CardContent>
                  </AppCard>
                  ...
                  <AppCard href="/personalize">
                    <CardContent className="px-4">
                      ...
                      <p className="text-sm font-medium text-body leading-snug">
                        Target users with tailored content
                      </p>
                    </CardContent>
                  </AppCard>
                  ...
                  <AppCard>
                    <CardContent className="px-4">
                      <div className="bg-surface-purple rounded-[var(--radius)] w-full h-24 flex items-center justify-center mb-3">
                        <div className="bg-white w-10 h-10 rounded-lg flex items-center justify-center">
                          <Image src="/images/automate.svg" alt="Automate" width={24} height={24} />
                        </div>
                      </div>
                      <h3 className="font-semibold text-base text-title mb-0.5">Automate</h3>
                      <p className="text-sm font-medium text-body leading-snug">
                        Integrate and simplify with clicks, not code
                      </p>
                    </CardContent>
                  </AppCard>
                  ...
                  <AppCard>
                    <CardContent className="px-4">
                      ...
                      <p className="text-sm font-medium text-body leading-snug">
                        Define brand content using AI rules
                      </p>
                    </CardContent>
                  </AppCard>
                  ...
                  <AppCard>
                    <CardContent className="px-4">
                      ...
                      <p className="text-sm font-medium text-body leading-snug">
                        Bring together world-class products
                      </p>
                    </CardContent>
                  </AppCard>
                  ...
                  <AppCard>
                    <CardContent className="px-4">
                      ...
                      <p className="text-sm font-medium text-body leading-snug">
                        Learn Contentstack with guided courses and...
                      </p>
                    </CardContent>
                  </AppCard>
                  ...
                  <AppCard disabled>
                    <CardContent className="px-4">
                      ...
                      <p className="text-sm font-medium text-body leading-snug">
                        View usage data across Contentstack
                      </p>
                    </CardContent>
                  </AppCard>
            ...
            <div className="space-y-8 px-2">
                ...
                <Card className="border py-2">
                  <CardContent className="px-4 py-0">
                    <div className="divide-y">
                      <a
                        href="#"
                        className="flex items-center gap-4 py-2 px-2 text-primary underline"
                      >
                        <svg
                          width="24"
                          height="24"
                        ...
                        >
                          <path
                            fillRule="evenodd"
                            clipRule="evenodd"
                            d="M14.676 10.714c.872.51.872 1.788 0 2.299l-3.033 1.778c-.872.51-1.962-.128-1.962-1.15v-3.555c0-1.022 1.09-1.661 1.962-1.15l3.033 1.778Zm-.56 1.314a.191.191 0 0 0 0-.329l-3.034-1.778a.187.187 0 0 0-.28.165v3.555c0 .146.156.237.28.164l3.033-1.777Z"
                            fill="#475161"
                          ></path>
                          <path
                            fillRule="evenodd"
                            clipRule="evenodd"
                            d="M18.607 3.029C19.86 2.817 21 3.798 21 5.087V17.44c0 .805-.772 1.378-1.528 1.133a6.091 6.091 0 0 0-5.922 1.242l-1.182 1.045a.554.554 0 0 1-.736 0l-1.182-1.045a6.091 6.091 0 0 0-5.922-1.242C3.772 18.818 3 18.245 3 17.44V5.087c0-1.29 1.14-2.27 2.393-2.058L12 4.147l6.607-1.118ZM4.121 17.439c0 .036.033.06.066.05a7.2 7.2 0 0 1 7 1.468l.813.72.814-.72a7.2 7.2 0 0 1 7-1.468.05.05 0 0 0 .065-.05V5.088a.939.939 0 0 0-1.088-.936L12 5.301 5.208 4.15a.939.939 0 0 0-1.087.936V17.44Z"
                            fill="#475161"
                          ></path>
                        </svg>
                      ...
                      >
                        ...
                        >
                          <path
                            fillRule="evenodd"
                            clipRule="evenodd"
                            d="M4.875 4.688a.188.188 0 0 0-.188.187v14.25c0 .104.084.188.188.188h14.25a.187.187 0 0 0 .188-.188V4.875a.187.187 0 0 0-.188-.188H4.875Zm-1.313.187c0-.725.588-1.313 1.313-1.313h14.25c.725 0 1.313.588 1.313 1.313v14.25c0 .725-.588 1.313-1.313 1.313H4.875a1.312 1.312 0 0 1-1.313-1.313V4.875Z"
                            fill="#475161"
                          ></path>
                          <path
                            fillRule="evenodd"
                            clipRule="evenodd"
                            d="M12 3.563c.31 0 .563.251.563.562v15.75a.562.562 0 1 1-1.126 0V4.125c0-.31.252-.563.563-.563Z"
                            fill="#475161"
                          ></path>
                          <path
                            fillRule="evenodd"
                            clipRule="evenodd"
                            d="M11.438 7.5c0-.31.251-.563.562-.563h7.875a.562.562 0 1 1 0 1.125H12a.562.562 0 0 1-.563-.562ZM11.438 10.5c0-.31.251-.563.562-.563h7.875a.562.562 0 1 1 0 1.126H12a.562.562 0 0 1-.563-.563ZM11.438 13.5c0-.31.251-.563.562-.563h7.875a.562.562 0 1 1 0 1.126H12a.562.562 0 0 1-.563-.563ZM11.438 16.5c0-.31.251-.563.562-.563h7.875a.562.562 0 1 1 0 1.126H12a.562.562 0 0 1-.563-.563Z"
                            fill="#475161"
                          ></path>
                        </svg>
                      ...
                      >
                        ...
                        >
                          <path
                            d="M9.083 16.633a22.25 22.25 0 0 1-1.325 1.741C4.4 18.28 3.125 16.1 3.125 16.1a20.403 20.403 0 0 1 2.19-8.885 7.496 7.496 0 0 1 4.268-1.583l.455 1.05c.65-.09 1.306-.136 1.962-.14.66.002 1.318.048 1.97.136l.456-1.051a7.496 7.496 0 0 1 4.269 1.597 20.404 20.404 0 0 1 2.18 8.876s-1.274 2.18-4.633 2.275a21.587 21.587 0 0 1-1.302-1.734m2.94-1.32c-1.747.886-3.438 1.77-5.88 1.77-2.442 0-4.133-.884-5.88-1.77"
                            stroke="#475161"
                            strokeLinecap="round"
                            strokeLinejoin="round"
                          ></path>
                          <path
                            d="M9.2 14.54a1.525 1.525 0 1 0 0-3.049 1.525 1.525 0 0 0 0 3.05ZM14.8 14.54a1.525 1.525 0 1 0 0-3.049 1.525 1.525 0 0 0 0 3.05Z"
                            stroke="#475161"
                            strokeLinecap="round"
                            strokeLinejoin="round"
                          ></path>
              ...
              <div>
                <div className="flex items-center justify-between mb-4">
                  ...
                  <button className="text-sm text-primary hover:underline pr-4 font-bold">
                    See All (4)
                  </button>
                </div>
                <Card className="border">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="space-y-1">
                        <h3 className="text-lg font-bold text-title">
                          Tech for Retail | Nov 24-25, 2025
                        </h3>
                        <p className="text-sm font-medium text-body leading-snug">
                          Meet us at booth B109 at the European trade show that is reinventing
                          retail.
                        </p>
                      </div>
