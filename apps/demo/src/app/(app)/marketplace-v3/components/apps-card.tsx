...
.mp-apps-card .mp-apps-body {
  margin-top: 1px;
  background-color: rgb(255, 255, 255);
}
.mp-apps-card:hover .mp-apps-body {
  margin-top: -100px;
  position: relative;
...
.mp-apps-card .mp-apps-link-icon {
  display: none;
}
.mp-apps-card:hover .mp-apps-link-icon {
...
export function AppsCard({ title, icon, subtitle, description }: AppsCardProps) {
  return (
    <>
      <style>{styles}</style>
      <div className="mp-apps-card">
        <div style={{ width: '100%' }}>
          {/* Cover area */}
          ...
          <div className="mp-apps-body" style={{ padding: 16, height: 138 }}>
            <div style={{ marginBottom: 8 }}>
              <div style={{ display: 'flex', alignItems: 'center', marginBottom: 12, height: 24 }}>
                ...
                <span className="mp-apps-link-icon"><LinkIcon /></span>
              </div>
              {subtitle && (
