...
.mp-cm-card .mp-cm-body {
  margin-top: 1px;
  background-color: rgb(255, 255, 255);
}
.mp-cm-card:hover .mp-cm-body {
  margin-top: -100px;
  position: relative;
...
.mp-cm-card .mp-cm-link-icon {
  display: none;
}
.mp-cm-card:hover .mp-cm-link-icon {
    ...
    <>
      ...
      <div className="mp-cm-card">
        <div style={{ width: '100%' }}>
          ...
          <div className="mp-cm-body" style={{ padding: 16 }}>
            <div style={{ display: 'flex', alignItems: 'center', height: 24, marginBottom: 12 }}>
              ...
              <span className="mp-cm-link-icon"><LinkIcon /></span>
            </div>
            {description && (
