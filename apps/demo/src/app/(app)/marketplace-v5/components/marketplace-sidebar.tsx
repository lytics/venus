 ...
 *
 * Collections: All Collections, Apps, Starters, Content Models, Recipes
 * Categories (24 items): A/B Testing, AI Assistance, Analytics, Artificial Intelligence,
 *   Automate, Automations, Commerce, Communication, Content Management, DAM, Development,
 *   Formatting, Hosting, Identity Management, Marketing, Messaging Queue, Miscellaneous,
 *   Personalization, Project Management, Referencing, Search, Storage, Translation, Video
 */
