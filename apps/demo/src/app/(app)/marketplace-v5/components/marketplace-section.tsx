...
/**
 * Marketplace Section - Reusable section component
 *
 * Used for: Apps, Starters, Content Models, Recipes sections
 * From capture: Section title with "View All X" link
 */
