...
/**
 * Marketplace V5 - Built with validation-first process
 *
 * ALL DATA COMES FROM VERIFIED VACUUM CAPTURE EXTRACTION
 * No invented content - only what was explicitly extracted from captures
 *
 * Apps: AI Assistant, Algolia, Automate (all "Stack App")
 * Starters: Kickstart Next.js, Kickstart NuxtJS, React Starter
 * Content Models: Hero Banner, Website Homepage, Blog Landing Page
 * Recipes: Backup Entries to AWS S3
 */
...
/* -------------------------------------------------------------------------- */
/*  VERIFIED DATA FROM CAPTURE                                                  */
/* -------------------------------------------------------------------------- */

// Apps: AI Assistant, Algolia, Automate (all "Stack App" subtitle, "Install" button)
const APPS = [
  {
    title: "AI Assistant",
...
// Starters: Kickstart Next.js, Kickstart NuxtJS, React Starter ("Import" button)
const STARTERS = [
  {
...
// Content Models: Hero Banner, Website Homepage, Blog Landing Page ("Import" button)
...
// Recipes: Backup Entries to AWS S3 ("Import" button)
const RECIPES = [
  {
